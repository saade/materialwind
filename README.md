...
**[Documentation and live playground](https://materialwind.saade.dev/)**
...
The documentation site lives in [saade/materialwind-docs][docs] and installs this
package from npm. To preview an unreleased change there, point its dependency at
a local checkout of this repo.

[docs]: https://github.com/saade/materialwind-docs
...
configured, so the first release was published manually. Every release since runs
from CI.
